...
```mermaid
graph LR
    A[Créateur Solo] -->|Étape 1: Délégation du montage| B[Directeur Artistique]
    B -->|Étape 2: Forfaits mensuels| C[Revenus Récurrents]
    C -->|Étape 3: Services 3D / VFX| D[Agence Premium Studios 700]
```
