...
```mermaid
graph TD
    AV[Alex Vianney - Le Réalisateur] -->|Apporte la vision artistique et la notoriété| S700[Studios 700 - L'Agence]
    S700 -->|Gère la logistique, facturation, équipe et délégation| AV
```
